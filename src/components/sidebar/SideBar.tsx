...
const SideBar = () => {
  ...
  return (
    <div className='fixed bg-white inset-0 min-h-screen h-full w-[244px] 3xl:w-[335px]'>
      {/* transform translate  toggle */}
      <div className='  translate-x-0 w-full  p-3 pb-5 text-sm flex flex-col z-[1] border-r-[1px] border-solid border-slate-300  h-full  '> 
        {/* logo */}
        <div className=' shrink-0 h-[92px] relative  mb-5 w-full'>
          <div className=' px-3 pt-6 pb-4 w-full'>
            {/* opacity: 1 */}
          ...
          <div className=''>
            <Link href="/" className='inline'>
              <div className='inline-flex w-full px-3 items-center  rounded-3xl cursor-pointer my-2 h-[48px]  ' >
                ...
                {/* feild */}
                <div className='flex px-4 items-center w-fit  h-6'>
                  <div className='block overflow-hidden text-ellipsis whitespace-nowrap text-[16px]'>Search</div>
                </div>
              </div>
            </Link>
          </div>
          ...
          <div className=' grow  '>
            <Link href="/" className='inline'>
              <div className='inline-flex w-full px-3 items-center  rounded-3xl cursor-pointer my-2 h-[48px]  ' >
                ...
                {/* feild */}
                <div className='flex px-4 items-center w-fit  h-6'>
                  <div className='block overflow-hidden text-ellipsis whitespace-nowrap text-[16px]'>Create</div>
                </div>
              </div>
            </Link>
          </div>
        ...
        {/* More */}
        <div className='shrink-0 w-full justify-end'>
          <div className=''>
            <Link href="/" className='inline'>
              <div className='inline-flex w-full px-3 items-center  rounded-3xl cursor-pointer my-2 h-[48px]  ' >
                {/* logo */}
